...
| 1 | robot tactile sensing | `https://roboskin.ai/tactile-ai` | `https://roboskin.ai/sensors` | System-level sensing, representation, and control path. |
...
| 2 | tactile sensors for robots | `https://roboskin.ai/sensors` | `https://roboskin.ai/robot-hands` | Structured sensor directory with a hand-level application route. |
| 2 | tactile sensor robot hand | `https://roboskin.ai/robot-hands` | `https://roboskin.ai/humanoid-robot-skin` | Hand-level grasp, slip, and manipulation intent. |
| 2 | humanoid tactile sensing | `https://roboskin.ai/humanoid-robot-skin` | `https://roboskin.ai/robot-hands` | Humanoid-specific tactile system intent. |
...
| 2 | artificial skin for robots | `https://roboskin.ai/robot-skin` | `https://roboskin.ai/e-skin` | Artificial-skin category and electronic-skin context. |
...
| 3 | soft tactile sensor | `https://roboskin.ai/sensors` | `https://roboskin.ai/robot-skin` | Soft-material sensor applications and design tradeoffs. |
...
| 3 | Physical AI tactile sensing | `https://roboskin.ai/physical-ai-touch` | `https://roboskin.ai/physical-ai` | Touch as a perception and feedback channel for Physical AI. |
...
| --- | --- | --- | --- |
| AI and robotics / AI in robotics / artificial intelligence and robotics | `https://roboskin.ai/ai-robotics` | `https://roboskin.ai/robot-learning`, `https://roboskin.ai/robot-vla-models`, `https://roboskin.ai/robot-foundation-models`, `https://roboskin.ai/robot-world-models`, `https://roboskin.ai/physical-ai` | The parent owns the relationship between AI model roles and robot embodiment, control, action, and feedback. Supporting routes retain learning, VLA, model-transfer, prediction, and Physical AI intent. |
| humanoid robots / humanoid robotics | `https://roboskin.ai/humanoid-robots` | `https://roboskin.ai/humanoid-robot-skin`, `https://roboskin.ai/physical-ai`, `https://roboskin.ai/robot-hands` | The parent owns the broad embodiment and research map. `/humanoid-robot-skin` remains canonical for skin, touch, and whole-body tactile sensing. |
...
| robot foundation models / generalist robot models | `https://roboskin.ai/robot-foundation-models` | `https://roboskin.ai/robot-vla-models`, `https://roboskin.ai/robot-world-models`, `https://roboskin.ai/tactile-foundation-models`, `https://roboskin.ai/robotics-datasets` | The parent owns broad model-role, pretraining, transfer, access, and evidence intent. VLA, predictive-world, and tactile-model pages retain their narrower technical roles. |
| robot manipulation / robotic manipulation | `https://roboskin.ai/robot-manipulation` | `https://roboskin.ai/tactile-manipulation`, `https://roboskin.ai/guides/tactile-sensor-benchmark-robot-manipulation`, `https://roboskin.ai/robot-hands` | The parent owns broad task families and system evaluation. `/tactile-manipulation` retains the contact-to-action technical loop. |
| robot hands / robotic hands / dexterous robot hand | `https://roboskin.ai/robot-hands` | `https://roboskin.ai/humanoid-robot-skin`, `https://roboskin.ai/robot-manipulation`, `https://roboskin.ai/sensors` | The parent owns hand-versus-gripper architecture, actuation, sensing, and evaluation. Supporting pages retain humanoid, task, and sensor evidence. |
...
Do not create separate synonym pages for `humanoid robotics`, `robotic manipulation`, `VLA robotics`, or `generalist robotics foundation model` until Search Console proves a materially different intent.
...
| robot hands / dexterous robot hands | `https://roboskin.ai/robot-hands` | `https://roboskin.ai/humanoid-robot-skin`, `https://roboskin.ai/robot-manipulation`, `https://roboskin.ai/sensors` | Compare end-effector architecture, actuation, degrees of freedom, tactile coverage, control, and task evidence. | Track hand and gripper variants separately in GSC, but keep one canonical comparison owner until intent diverges. |
...
| physical ai robot skin | `https://roboskin.ai/physical-ai` | `https://roboskin.ai/`, `https://roboskin.ai/robot-skin`, `https://roboskin.ai/guides/tactile-feedback-for-physical-ai` | Define the broad Physical AI system and how robot skin supports contact feedback. | Track impressions and average position for the query and close variants. |
| humanoid robot tactile sensing | `https://roboskin.ai/humanoid-robot-skin` | `https://roboskin.ai/`, `https://roboskin.ai/applications`, `https://roboskin.ai/robot-hands` | Explain tactile coverage, robot hands, slip, and contact feedback for humanoid robots. | Strengthen the canonical pillar before adding another humanoid overview. |
| embodied ai touch | `https://roboskin.ai/physical-ai-touch` | `https://roboskin.ai/`, `https://roboskin.ai/physical-ai`, `https://roboskin.ai/tactile-ai` | Connect embodied or physical-world AI to tactile sensing and contact data. | Keep the broad definition on `/physical-ai`; keep tactile intent on `/physical-ai-touch`. |
| robot manipulation tactile sensor | `https://roboskin.ai/guides/tactile-sensor-benchmark-robot-manipulation` | `https://roboskin.ai/`, `https://roboskin.ai/robot-hands`, `https://roboskin.ai/technology` | Compare tactile sensing methods by contact-rich manipulation task. | Add evidence to the benchmark instead of creating sensor-by-sensor thin pages. |
...
| physical ai tactile feedback | `https://roboskin.ai/guides/tactile-feedback-for-physical-ai` | `https://roboskin.ai/physical-ai`, `https://roboskin.ai/tactile-ai`, `https://roboskin.ai/physical-ai-touch` | Explain contact feedback loops, pressure, slip, and response paths for Physical AI. | Keep this as a supporting feedback-loop page under the top-level pillar. |
| robot skin for physical ai | `https://roboskin.ai/robot-skin` | `https://roboskin.ai/physical-ai`, `https://roboskin.ai/`, `https://roboskin.ai/humanoid-robot-skin` | Explain robot skin as the tactile surface and contact layer for embodied systems. | If the homepage ranks instead, add a stronger internal link to `/robot-skin`. |
| tactile ai robot skin | `https://roboskin.ai/tactile-ai` | `https://roboskin.ai/robot-skin`, `https://roboskin.ai/technology`, `https://roboskin.ai/sensors` | Explain the AI workflow that turns robot skin signals into behavior. | Compare CTR between `/tactile-ai` and `/technology` before title changes. |
| robot touch data | `https://roboskin.ai/physical-ai-touch` | `https://roboskin.ai/tactile-ai`, `https://roboskin.ai/research`, `https://roboskin.ai/physical-ai` | Explain tactile logs, contact events, and touch signal datasets. | Add source-backed examples if impressions appear with low average position. |
| humanoid robot skin tactile sensor | `https://roboskin.ai/humanoid-robot-skin` | `https://roboskin.ai/robot-hands`, `https://roboskin.ai/robot-skin`, `https://roboskin.ai/research` | Match application-level humanoid and hand sensing searches. | If `/research` ranks first, link from the ranking research page to the humanoid route. |
...
3. Record whether answer engines cite the homepage, `/ai-robotics`, `/physical-ai`, or a guide page.
