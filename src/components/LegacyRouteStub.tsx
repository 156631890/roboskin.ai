    ...
    <section className="py-20 md:py-24">
      <div className="container-shell">
        <div className="glass-card max-w-3xl p-8 md:p-10">
          ...
          <p className="mt-4 max-w-2xl text-soft">{description}</p>
          <div className="mt-8">
            <Link href={primaryHref} className="inline-flex rounded-xl bg-[var(--primary)] px-6 py-3 text-sm font-bold text-white">
              {primaryLabel}
            </Link>
          </div>
        </div>
