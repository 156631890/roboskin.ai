  ...
  return (
    <form className="glass-card space-y-5 p-6 md:p-8" onSubmit={handleSubmit}>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <label className="grid gap-2 text-sm text-[#9aa3b2]">
          Full name
          <input
            required
            value={form.fullName}
            onChange={(event) => updateField('fullName', event.target.value)}
            className="rounded-xl border border-white/8 bg-[#0d1016] px-4 py-3 text-white outline-none transition placeholder:text-[#6f7786] focus:border-[#62a8ff]/50 focus:ring-2 focus:ring-[#62a8ff]/20"
          />
        </label>
        <label className="grid gap-2 text-sm text-[#9aa3b2]">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <label className="grid gap-2 text-sm text-[#9aa3b2]">
          ...
          <select
            ...
            className="rounded-xl border border-white/8 bg-[#0d1016] px-4 py-3 text-white outline-none transition focus:border-[#62a8ff]/50 focus:ring-2 focus:ring-[#62a8ff]/20"
          >
      ...
      <button
        ...
        className="inline-flex rounded-xl bg-[#62a8ff] px-6 py-3 text-sm font-bold text-white shadow-[0_12px_26px_rgba(98,168,255,0.22)] transition-transform hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-70"
      >
      ...
      <p className="text-sm text-[#9aa3b2]">
        For direct inquiries: <a className="text-[#62a8ff] hover:text-[#7dd3fc]" href={`mailto:${site.contact.primaryEmail}`}>{site.contact.primaryEmail}</a>
      </p>
    </form>
  );
}
