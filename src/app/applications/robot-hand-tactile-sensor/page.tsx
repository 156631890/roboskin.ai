...
const page = getSeoTopicPage('/applications/robot-hand-tactile-sensor');

export function generateMetadata(): Metadata {
  if (!page) {
    return {
      title: 'Robot hand tactile sensor topic not found',
    };
  }
...
export default function RobotHandTactileSensorPage() {
  if (!page) {
    notFound();
  }
