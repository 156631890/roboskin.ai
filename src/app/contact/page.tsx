        ...
        <div className="container-shell grid items-center gap-9 md:grid-cols-[1fr_0.95fr]">
          <div>
            ...
            <div className="mt-8 space-y-2 text-sm text-slate-300">
              <p>Primary: <a className="text-cyan-200" href={`mailto:${site.contact.primaryEmail}`}>{site.contact.primaryEmail}</a></p>
              <p>Sales: <a className="text-cyan-200" href={`mailto:${site.contact.salesEmail}`}>{site.contact.salesEmail}</a></p>
              <p>Legal: <a className="text-cyan-200" href={`mailto:${site.contact.legalEmail}`}>{site.contact.legalEmail}</a></p>
            </div>
          </div>
          <div className="glass-card min-h-72 rounded-[20px] border border-cyan-200/15 p-6">
            <div className="flex h-full items-center justify-center rounded-[16px] border border-white/8 bg-[linear-gradient(145deg,rgba(10,30,52,0.75),rgba(4,16,33,0.9))] p-6">
              <div className="max-w-sm text-center">
                <p className="text-sm uppercase tracking-[0.16em] text-cyan-100/70">Next step</p>
      ...
      <section className="pb-20">
        <div className="container-shell grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="glass-card p-6 md:p-8">
            ...
            <div className="mt-8 rounded-2xl border border-cyan-200/15 bg-white/5 p-5">
