      ...
      <section className="py-20 md:py-24">
        <div className="container-shell grid items-center gap-9 md:grid-cols-[1fr_0.95fr]">
          <div>
            ...
            <p className="mt-5 max-w-xl text-[#9aa3b2]">
              Tell us your use case, target form factor, and timeline. We&apos;ll help you find the right sensor or integration path.
            </p>
            <div className="mt-8 space-y-2 text-sm text-[#9aa3b2]">
              <p>Primary: <a className="text-[#62a8ff] hover:text-[#7dd3fc]" href={`mailto:${site.contact.primaryEmail}`}>{site.contact.primaryEmail}</a></p>
              <p>Sales: <a className="text-[#62a8ff] hover:text-[#7dd3fc]" href={`mailto:${site.contact.salesEmail}`}>{site.contact.salesEmail}</a></p>
              <p>Legal: <a className="text-[#62a8ff] hover:text-[#7dd3fc]" href={`mailto:${site.contact.legalEmail}`}>{site.contact.legalEmail}</a></p>
            </div>
          </div>
          <div className="glass-card min-h-72 rounded-[20px] border border-white/8 p-6">
            <div className="flex h-full items-center justify-center rounded-[16px] border border-white/8 bg-[#0d1016] p-6">
              <div className="max-w-sm text-center">
                <p className="text-sm uppercase tracking-[0.16em] text-[#9aa3b2]">Next step</p>
      ...
      <section className="pb-20">
        <div className="container-shell grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="glass-card p-6 md:p-8">
            ...
            <ul className="mt-5 space-y-3 text-sm text-[#9aa3b2]">
