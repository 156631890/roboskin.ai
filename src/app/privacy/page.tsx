    ...
    <>
      <section className="py-20 md:py-24">
        <div className="container-shell">
          ...
          <p className="mt-5 max-w-3xl text-slate-300">Last updated: April 8, 2026</p>
        </div>
      </section>
        ...
        <div className="container-shell">
          <div className="glass-card space-y-8 p-8 md:p-10">
            ...
            <div>
              ...
              <p className="mt-3 text-slate-300">
                For privacy questions, email <a className="text-cyan-200" href={`mailto:${site.contact.privacyEmail}`}>{site.contact.privacyEmail}</a>.
              </p>
            </div>
          </div>
        </div>
