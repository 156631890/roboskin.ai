...
export const tactileDatasetEntries: TactileDatasetEntry[] = [
  {
    id: 'bench2dex',
    name: 'Bench2Dex simulation demonstrations',
    institution: ['Shanghai Jiao Tong University', 'Fudan University', 'The University of Hong Kong', 'Inspire Robots', 'Zhongguancun Academy', 'COWARobot Co. Ltd', 'Nanyang Technological University'],
    year: 2026,
    ...
    paperVersion: 'arXiv v1 (2609.15726v1)',
    ...
    sampleCount: 'About 1,300 human-teleoperated simulation demonstrations in the v1 paper. Public hosting separately lists 5,200 HDF5 file paths; file paths are not a verified count of unique demonstrations.',
    tasks: ['Bimanual tool use', 'Articulated-object interaction', 'Multi-stage manipulation', 'Controlled scene perturbations'],
    objectCategories: 'Task-specific tools, containers, articulated objects and assembly items; a deduplicated released object count is unknown.',
    dataFormat: 'HDF5 episodes. The documented schema aligns frame_index, timestamp_ns and sim_step; action commands precede the next simulator step and observations follow it. Actions include names, control mode, validity and source. Supported fields are not guaranteed in every payload; README says depth is omitted in the current storage workflow.',
    license: 'Repository root MIT applies to code; no separate dataset-file license or collection-wide model/asset license was verified.',
    codeLicense: 'MIT at repository revision f96a8b2b4eb475483af66e9e03916b35bc43f1be.',
    assetLicense: 'Unknown collection-wide terms; upstream robot and object asset licenses require separate review.',
    modelLicense: 'Unknown: no top-level weight license or model card verified; base-model terms may differ.',
    ...
    githubUrl: 'https://github.com/Bench2Dex/Bench2Dex',
    datasetUrl: 'https://huggingface.co/datasets/Bench2Dex/teleopdata/tree/b195787c65046083e6a43776b67bdf1389dfa3eb',
    researchUrl: '/research/bench2dex-visuo-tactile-bimanual-benchmark-2026',
    availability: 'Public, ungated provider manifest verified on 2026-09-18. Dataset payloads were not downloaded; completeness, checksums, schema validity and permission to reuse data remain unverified. Paper-scale demonstrations and hosted file counts are different units.',
  ...
  },
  {
    id: 'tacverse',
    name: 'TacVerse',
    institution: ['Imperial College London', 'Queen Mary University of London', 'King’s College London'],
    year: 2026,
    ...
    license: 'CC BY 4.0 in the official Hugging Face metadata; access is gated and asset-specific terms were not independently checked',
    paperUrl: 'https://arxiv.org/abs/2606.25877',
    projectUrl: 'https://lannwei.github.io/Tactile_Database/',
    githubUrl: 'https://github.com/LannWei/Tactile_Database',
    datasetUrl: 'https://huggingface.co/datasets/Lan-2025/Tactile',
    researchUrl: '/research/tacverse-cross-sensor-tactile-dataset-2026',
    availability: 'Official code and gated Hugging Face task archives verified on 2026-09-11. The 106,800-image count is paper-reported; files were not downloaded or recounted. No root code license was identified at the reviewed revision.',
    sourceReviewed: '2026-09-11',
  },
  {
    id: 'vtdexmanip',
    name: 'VTDexManip',
...
// Paper-associated candidates are deliberately outside the Dataset catalog and its statistics.
export const tactileDatasetCandidates: TactileDatasetEntry[] = [
  {
    id: 'star',
    name: 'STAR paper-associated dexterous manipulation data',
    institution: ['Shanghai Innovation Institute', 'Agibot'],
    year: 2026,
    authors: ['Xiangcheng Liu', 'Tianhao Wu', 'Le Zheng', 'Yidong Wang', 'Bowen Jiang', 'Mingjie Pan', 'Xinlin Ren', 'Yi Liu', 'Jianlan Luo'],
    firstPublished: '2026-09-11',
    paperVersion: 'arXiv v1 (2609.12549v1)',
    dataOrigin: 'real',
    robot: ['Bimanual wheeled mobile robot; two hands with 10 actuated DoF and 16 total DoF each; commercial model name unknown'],
    sensor: ['268-dimensional piezoresistive tactile sensing per hand', 'Two wrist RGB cameras and one head RGB camera'],
    modalities: ['Three-view RGB', 'Bilateral tactile signals', 'Robot state', 'Command actions', 'Task-level language instructions'],
    sampleCount: 'Author-reported 200 hours, 10,576 trajectories and 65 tasks. No hosted-file count verified.',
    tasks: ['Dexterous multi-finger manipulation', 'Pick-and-place and insertion', 'Long-horizon manipulation'],
    objectCategories: 'Task-specific household and manipulation objects; exhaustive inventory and unique object count unknown.',
    dataFormat: 'Paper describes timestamp alignment to 30 Hz; this is not the raw tactile sampling rate. Command actions use end-effector poses and hand joints (34 active dimensions, padded to 64 for the policy). Public package, file schema and train/validation/test manifests unknown.',
    license: 'Unknown: no dataset-file, code, weight or asset license verified. The arXiv article license does not license the described dataset.',
    codeLicense: 'Unknown',
    assetLicense: 'Unknown',
    modelLicense: 'Unknown',
    generalization: 'Evaluation objects are held out from 200-hour pretraining but used in 100 task-specific post-training trajectories per task; 20 evaluation trials per task use held-out initial configurations. Not unseen-object zero-shot generalization.',
    paperUrl: 'https://arxiv.org/abs/2609.12549v1',
    projectUrl: 'https://stardex-web.github.io/Star/',
    researchUrl: '/guides/tactile-feedback-for-physical-ai',
    availability: 'Paper-linked data candidate only. Official project reopened on 2026-09-18; no dataset download, code release or dataset reuse license verified. Excluded from the dataset catalog count, available-file filters and Dataset structured data.',
    sourceReviewed: '2026-09-18',
  },
];
