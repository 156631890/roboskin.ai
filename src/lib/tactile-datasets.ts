...
export const tactileDatasetEntries: TactileDatasetEntry[] = [
  ...
  },
  {
    ...
    dataFormat: "The paper defines I_marked, I_pure, depth maps, projected 2D marker coordinates and a 7D object pose. The public contact/<shape>/hdf5/ paths were inventoried at revision e1aee7b0c95543b535e0146b2de3ee1bc6ddaabd; payload arrays, frame totals and splits were not validated.",
    license: "The provider dataset card labels the repository MIT. This is separate from the code root Apache-2.0 license and does not resolve third-party asset or checkpoint terms.",
    ...
    datasetUrl: 'https://huggingface.co/datasets/byml/UniVTAC/tree/e1aee7b0c95543b535e0146b2de3ee1bc6ddaabd/contact',
    researchUrl: '/research/univtac-platform-encoder-benchmark-2026',
    availability: "Public contact-file listing verified on September 19, 2026. No standalone download establishing exact equivalence to the 205,826-sample paper corpus was verified; HDF5 payloads were not downloaded.",
  ...
  },
  {
    ...
    researchUrl: '/research/univtac-platform-encoder-benchmark-2026',
    availability: "Public file listing verified on September 19, 2026. Match main/Isaac Sim 4.5 to isaac45, or isaac51/Isaac Sim 5.1 to isaac51. The official repository states task data are not cross-compatible and released policy checkpoints target 4.5. See the research guide for the downloadable 30-row inventory and payload-verification limits.",
    sourceReviewed: "2026-09-19",
  },
  {
    id: 't-rex',
