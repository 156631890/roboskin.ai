...
export const robotAiModelEntries: RobotAiModelEntry[] = [
  ...
  },
  {
    ...
    embodiments: ['Google mobile-manipulator platform used by RT-1 and RT-2'],
  ...
  },
  {
    ...
    embodiments: ['Mobile robot in a kitchen', 'Tabletop manipulation robot', 'Simulated task-and-motion-planning agent'],
  ...
  },
  {
    ...
    embodiments: ['Multiple real-world manipulation platforms represented in Open X-Embodiment and the paper evaluation'],
  ...
  },
  {
    ...
    embodiments: ['Nine real-robot configurations across four institutions'],
  ...
  },
  {
    ...
    embodiments: ['Seven robot configurations in the original report', 'ALOHA and DROID-compatible adaptations in the current OpenPI release'],
  ...
  },
  {
    ...
    embodiments: ['Author-described real-world contact-rich manipulation platform; consult the paper for task-specific hardware'],
