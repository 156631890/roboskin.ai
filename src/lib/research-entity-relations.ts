...
const sourceAffiliationBatches: SourceAffiliationBatch[] = [
  {
    fromType: 'paper',
    fromId: 'univtac-platform-encoder-benchmark-2026',
    organizations: [
      { organizationId: 'scalelab', sourceLabels: ['ScaleLab, Shanghai Jiao Tong University'] },
      { organizationId: 'd-robotics', sourceLabels: ['D-Robotics'] },
      { organizationId: 'vitai-robotics', sourceLabels: ['ViTai Robotics'] },
      { organizationId: 'the-university-of-hong-kong', sourceLabels: ['The University of Hong Kong'] },
      { organizationId: 'nanjing-university', sourceLabels: ['Nanjing University'] },
      { organizationId: 'shenzhen-university', sourceLabels: ['Shenzhen University'] },
      { organizationId: 'wuhan-university', sourceLabels: ['Wuhan University'] },
      { organizationId: 'fudan-university', sourceLabels: ['Fudan University'] },
      { organizationId: 'tsinghua-university', sourceLabels: ['Tsinghua University'] },
    ],
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    evidenceBoundary: 'The UniVTAC paper author-affiliation block lists these nine normalized organizations, with ScaleLab separately linked to its host university. These relations preserve source-listed affiliations only; they do not establish institutional ownership, funding, endorsement, equal contribution, or responsibility for every artifact and result.',
...
export const researchManufacturingRelations: ManufacturedByRelation[] = [
  {
    ...
    toType: 'organization',
    toId: 'vitai-robotics',
    evidenceUrls: ['https://vitai.site/product/vt-gf225', 'https://vitai.site/about'],
    sourceLabels: ['VT-GF225', 'ViTai Robotics'],
    evidenceBoundary: 'The official ViTai company and product sources attribute the VT-GF225 tactile sensor to ViTai Robotics. This relation does not independently verify every manufacturer-reported specification, calibration mode, software output, current availability, pricing, certification, robot compatibility, or the UniVTAC paper results.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'manufacturedBy',
...
export const researchOrganizationPartOfRelations: OrganizationPartOfRelation[] = [
  {
    ...
    fromId: 'scalelab',
    toType: 'organization',
    toId: 'shanghai-jiao-tong-university',
    evidenceUrls: ['https://scalelab-sjtu.github.io/'],
    sourceLabels: ['ScaleLab', 'Shanghai Jiao Tong University'],
    evidenceBoundary: 'The official ScaleLab site identifies the laboratory with Shanghai Jiao Tong University. This relation records that host-university affiliation; it does not make the lab a university alias, separate legal entity, owner of every affiliated project, or representative of the university as a whole.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'partOf',
...
export const researchDatasetUsageRelations: DatasetUsageRelation[] = [
  {
    relation: 'usesSensor',
    fromType: 'dataset',
    fromId: 'univtac-benchmark-dataset',
    toType: 'sensor',
    toId: 'gelsight-mini',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093', 'https://huggingface.co/datasets/byml/UniVTAC'],
    sourceLabels: ['bilateral simulated GelSight Mini observations'],
    evidenceBoundary: 'The public 800-episode UniVTAC benchmark dataset uses simulated GelSight Mini observations in the authors’ Franka Panda configuration. This is not physical GelSight Mini data, does not establish simulation-to-real transfer, and must not be conflated with the 205,826-sample encoder pretraining corpus or the unreleased physical GF225 demonstrations.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'usesRobot',
    ...
    fromId: 'univtac-benchmark-dataset',
    toType: 'robot',
    toId: 'franka-panda-univtac-gelsight-mini-simulation-configuration',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093', 'https://huggingface.co/datasets/byml/UniVTAC'],
    sourceLabels: ['simulated Franka Panda with bilateral GelSight Mini sensors'],
    evidenceBoundary: 'The public UniVTAC benchmark data records the paper’s simulated Franka Panda and bilateral GelSight Mini configuration. This is a normalized simulation embodiment, not a physical-robot dataset, hardware compatibility guarantee, or evidence that the separate Tianji Marvin and GF225 physical demonstrations are included in the public files.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'usesRobot',
...
export const researchPaperSensorRelations: UsesSensorRelation[] = [
  {
    ...
    toId: 'gelsight-mini',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['simulated GelSight Mini sensors'],
    evidenceBoundary: 'The UniVTAC simulation benchmark renders bilateral GelSight Mini observations. This relation represents a simulated sensor configuration only; it does not imply use of physical GelSight Mini hardware, cross-sensor equivalence, simulation-to-real validation, or that all public UniVTAC components currently support the physical GF225 pipeline.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'usesSensor',
    ...
    toId: 'vitai-gf225',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['dual ViTai GF225 sensors at 30 Hz'],
    evidenceBoundary: 'The UniVTAC physical experiment mounts two ViTai GF225 sensors on the Tianji Marvin configuration and uses marker-derived RGB tactile input at 30 Hz. The relation does not establish that every GF225 SDK output or manufacturer specification was used, that the physical demonstrations are publicly released, or that current public collection code supports GF225.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'usesSensor',
...
export const researchSemanticRelations: ResearchSemanticRelation[] = [
  {
    ...
    fromId: 'univtac-platform-encoder-benchmark-2026',
    toType: 'model',
    toId: 'univtac-encoder',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['UniVTAC Encoder'],
    evidenceBoundary: 'The paper introduces the UniVTAC Encoder as a 512-dimensional ResNet-18 tactile representation encoder. This relation does not classify it as a VLA or general foundation model, promise cross-sensor transfer, establish independent reproduction, or make the separate UniTacVLA model an alias or successor.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'introduces',
    ...
    fromId: 'univtac-platform-encoder-benchmark-2026',
    toType: 'benchmark',
    toId: 'univtac-benchmark',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['UniVTAC eight-task simulation benchmark'],
    evidenceBoundary: 'The paper defines the eight-task UniVTAC simulation benchmark and reports author-run binary-success results. This is not an independent universal benchmark: the paper trains on 50 full trajectories per task, evaluates 100 simulation rollouts per method-task, and its protocol must not be merged with the three-task physical study.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'describesDataset',
    ...
    fromId: 'univtac-platform-encoder-benchmark-2026',
    toType: 'dataset',
    toId: 'univtac-encoder-pretraining-corpus',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['205,826-sample UniVTAC encoder pretraining corpus'],
    evidenceBoundary: 'The paper describes 205,826 simulated interaction samples used for encoder pretraining across 14 shapes. No standalone download for this corpus was verified; it is not the public 800-episode HDF5 benchmark release, the 400 policy-training trajectories, the simulation evaluation rollouts, or the unreleased physical demonstrations.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'describesDataset',
    ...
    fromId: 'univtac-platform-encoder-benchmark-2026',
    toType: 'dataset',
    toId: 'univtac-benchmark-dataset',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['public UniVTAC benchmark HDF5 episodes'],
    evidenceBoundary: 'The paper describes the simulated trajectories underlying the benchmark, while the pinned public Hugging Face revision contains 800 HDF5 episodes: 763 success and 37 non-success. Those files are not the paper’s 400 policy-training trajectories, 205,826 pretraining samples, evaluation rollouts, or 450 unreleased physical demonstrations.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'trainedOn',
    fromType: 'model',
    fromId: 'univtac-encoder',
    toType: 'dataset',
    toId: 'univtac-encoder-pretraining-corpus',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['multi-task pretraining on 205,826 simulated tactile interaction samples'],
    evidenceBoundary: 'The UniVTAC Encoder is pretrained on the separately modeled 205,826-sample simulated corpus. This relation does not state that the encoder was trained on the public 800-episode benchmark release, on the policy-training trajectories, on evaluation rollouts, or on the three-task physical GF225 demonstrations.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'evaluatedBy',
    ...
    toId: 'univtac-benchmark',
    evidenceUrls: ['https://arxiv.org/abs/2602.10093'],
    sourceLabels: ['ACT plus UniVTAC Encoder on the eight-task benchmark'],
    evidenceBoundary: 'The paper evaluates ACT augmented with the UniVTAC Encoder on eight simulated tasks, reporting a 48.0% average versus 30.9% for vision-only ACT, a 17.1 percentage-point difference. This is not a relative 17.1% gain, and hosted checkpoint logs differ from Table I, so this edge does not claim public reproduction or independent validation.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'evaluatedBy',
    ...
    sourceLabels: ['ViTaR evaluation on a seven-task UniVTAC subset'],
    evidenceBoundary: 'ViTaR uses a seven-task subset of the UniVTAC protocol that excludes Insert Hole, with 50 training trajectories per task and 100 evaluation episodes per method-task, and reports a 61.3% average. It must not be represented as the original eight-task UniVTAC Table I result or compared directly with the 48.0% UniVTAC Encoder average without protocol qualification.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'introduces',
  ...
  },
  {
    ...
    toType: 'dataset',
    toId: 'egotouch',
    evidenceUrls: ['https://arxiv.org/abs/2607.07287'],
    sourceLabels: ['Tactile World Model pretraining on EgoTouch human interaction video data'],
    evidenceBoundary: 'The TouchWorld v2 preprint says its tactile world-model component is first pretrained on EgoTouch and then fine-tuned on ten hours of robot demonstrations. This relation applies to that component and training stage; it does not imply that every TouchWorld module is trained on EgoTouch, that the hosted EgoTouch upload is complete, or that human and robot tactile layouts are interchangeable.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'evaluatedBy',
    ...
    fromId: 'touchworld',
    toType: 'benchmark',
    toId: 'touchworld-real-robot',
    evidenceUrls: ['https://arxiv.org/abs/2607.07287'],
    sourceLabels: ['TouchWorld six-task real-robot benchmark with clean and human-perturbation settings'],
    evidenceBoundary: 'The TouchWorld authors define and run this six-task evaluation on one unnamed humanoid with Wuji hands and a JQ-Industries tactile glove. The edge records the model-to-protocol evaluation only; it does not make the benchmark independent, universal, cross-sensor, cross-robot, peer reviewed, or directly comparable with unlike tactile-model results.',
    sourceReviewed: '2026-08-22',
  },
  {
    relation: 'trainedOn',
