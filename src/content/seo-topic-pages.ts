...
export const seoTopicPages: SeoTopicPage[] = [
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'Robot platforms and embodiments', href: '/robots', description: 'Trace exact, family-level, and unnamed hardware to evaluated-on, trained-across, or demonstrated-on evidence.' },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'UniVTAC platform, encoder, and benchmark', href: '/research/univtac-platform-encoder-benchmark-2026', description: 'Separate 205,826 pretraining samples, 800 public episodes, policy data, evaluation rollouts, and physical evidence.' },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'UniVTAC tactile simulation and physical transfer', href: '/research/univtac-platform-encoder-benchmark-2026', description: 'Follow simulated contact data through a tactile representation, task policy, and protocol-bounded physical evaluation.' },
    ...
    sources: [
      { label: 'Humanoid visual-tactile-action dataset preprint', href: 'https://arxiv.org/html/2510.25725v2' },
      { label: 'FreeTacMan visuo-tactile data collection preprint', href: 'https://arxiv.org/abs/2506.01941' },
      ...
      { label: 'UniVTAC simulation, representation, and benchmark preprint', href: 'https://arxiv.org/abs/2602.10093' },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      { label: 'FreeTacMan preprint', href: 'https://arxiv.org/abs/2506.01941' },
      { label: 'Humanoid visual-tactile-action dataset preprint', href: 'https://arxiv.org/html/2510.25725v2' },
      { label: 'Sparsh-X multisensory touch preprint', href: 'https://arxiv.org/html/2506.14754v1' },
      ...
      { label: 'EgoTouch official repository', href: 'https://github.com/Jianyi2004/TouchAnything' },
      { label: 'EgoTouch official Hugging Face repository', href: 'https://huggingface.co/datasets/zhouzhoujy/EgoTouch' },
    ...
    paperBriefIds: ['tacverse-cross-sensor-tactile-dataset-2026', 'prism-contact-rich-industrial-skill-dataset-2026', 'ht-bench-full-hand-tactile-representations-2026', 'freetacman-robot-free-visuotactile-data-collection-2025', 'humanoid-visual-tactile-action-dataset-2025'],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'The table compares architectural role and evidence boundary. It does not rank unlike systems by one score. MiTaS and UniVTAC Encoder are included as related tactile learning systems, not labeled here as general-purpose foundation models.',
        ],
        table: {
          ...
          rows: [
            ...
            ['UniVTAC Encoder', 'Pretrained tactile representation encoder', 'Maps tactile images to a 512-dimensional ResNet-18 feature using simulated shape, contact, and pose supervision.', 'Eight simulated benchmark tasks plus three physical tasks on a separate GF225-equipped robot.', '2026 preprint and related representation model; it is not a VLA or a demonstrated sensor-independent foundation model.'],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Its tactile world-model component is first pretrained on EgoTouch and then adapted to robot demonstrations. RoboSkin keeps that training resource separate from the authors’ six-task evaluation protocol so a dataset, model, and benchmark are not collapsed into one claim.',
        ],
      },
      {
    ...
    relatedLinks: [
      ...
      { label: 'TouchWorld model record', href: '/robot-foundation-models#model-touchworld', description: 'Inspect the normalized model, training, evaluation, availability, and limitation fields.' },
      { label: 'EgoTouch dataset record', href: '/datasets#dataset-egotouch', description: 'Inspect the human bimanual pretraining resource and its incomplete-upload boundary.' },
      { label: 'TouchWorld evaluation protocol', href: '/benchmarks#benchmark-touchworld-real-robot', description: 'Inspect the six-task, single-platform evaluation contract.' },
      { label: 'Robot world models', href: '/robot-world-models', description: 'Separate predictive dynamics from planning, policy, and foundation-model claims.' },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'TouchWorld evaluation protocol', href: '/benchmarks#benchmark-touchworld-real-robot', description: 'Inspect an author-defined six-task real-robot protocol and its single-platform boundary.' },
    ...
    sources: [
      ...
      { label: 'TouchWorld tactile foundation model preprint', href: 'https://arxiv.org/abs/2607.07287' },
      { label: 'TouchWorld official project page', href: 'https://phanes-lab.github.io/TouchWorld-website/' },
    ],
    paperBriefIds: ['tacverse-cross-sensor-tactile-dataset-2026', 'ht-bench-full-hand-tactile-representations-2026'],
  },
  {
    path: '/sensors',
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'Verified robot platforms', href: '/robots', description: 'Trace named humanoids and research configurations to bounded model-training, evaluation, and demonstration evidence.' },
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Model ecosystem and release boundaries',
        body: [
    ...
    faqs: [
      ...
      { question: 'Where can I find VLA model code and weights?', answer: 'OpenVLA’s official project links its code and model checkpoints. Access differs across other VLA systems: some release weights and training code, while others provide a paper, a repository placeholder, or only selected controllers and datasets. Check the access and license fields for the exact release before planning a reproduction.' },
      { question: 'What is the difference between UniTacVLA and VLA-Touch?', answer: 'UniTacVLA combines tactile understanding, future-touch prediction, and residual action correction. VLA-Touch adds tactile-language feedback to planning and uses a controller to refine VLA actions. Their robots, evaluation protocols, and public artifacts differ, so the reported results are not directly comparable.' },
    ...
    sources: [
      ...
      { label: 'UniTacVLA repository and release status', href: 'https://github.com/ZhangXD-666/UniTacVLA' },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'UniVTAC tactile simulation and learning', href: '/research/univtac-platform-encoder-benchmark-2026', description: 'Trace encoder samples, policy trajectories, hosted task episodes, physical demonstrations, and evaluation rollouts as separate evidence.' },
    ],
    sources: [
    ...
    paperBriefIds: ['univtac-platform-encoder-benchmark-2026', 'adept-visuo-tactile-dexterity-rl-2026', 'ht-bench-full-hand-tactile-representations-2026', 'freetacman-robot-free-visuotactile-data-collection-2025', 'dream-tac-tactile-world-action-model-2026', 't-rex-tactile-reactive-dexterous-manipulation-2026', 'robotacdex-humanoid-visual-tactile-action-dataset-2026'],
  },
  {
    path: '/robot-hands',
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: 'TouchWorld news brief', href: '/news/touchworld-tactile-foundation-model-dexterous-manipulation-2026', description: 'Follow one predictive-and-reactive tactile model from primary sources to evidence boundaries.' },
      { label: 'TouchWorld model record', href: '/robot-foundation-models#model-touchworld', description: 'Inspect the normalized model record and source-bounded training and evaluation fields.' },
      { label: 'EgoTouch dataset record', href: '/datasets#dataset-egotouch', description: 'Inspect the human tactile resource used in TouchWorld pretraining.' },
      { label: 'TouchWorld evaluation protocol', href: '/benchmarks#benchmark-touchworld-real-robot', description: 'Inspect the single-platform, six-task protocol separately from the model claim.' },
