...
export const site = {
  ...
  contact: {
    primaryEmail: 'hello@roboskin.ai',
    ownerEmail: 'hello@roboskin.ai',
    inquiryEmail: 'hello@roboskin.ai',
    legalEmail: 'hello@roboskin.ai',
    privacyEmail: 'hello@roboskin.ai',
...
export const homeStats = [
  ...
  { value: '65', label: 'Source-backed research and robotics news briefs' },
...
export const productCards = [
  {
    name: 'Understand what the robot needs to sense',
    bestFor: 'Readers choosing between contact detection, a tactile fingertip, and a distributed skin',
    summary: 'Start with the difference between a sensing element and an integrated robot surface. Identify the contact location, measured signal, and action the robot should take.',
    inputsOutputs: 'A task description becomes a list of required contact signals and coverage areas.',
    specs: ['Contact events', 'Pressure and force measurements', 'Surface coverage', 'Robot skin and e-skin terminology'],
    evaluation: ['Where can contact happen?', 'Is a binary event enough?', 'Does the task need contact location or a spatial map?', 'What response will use the signal?'],
    verificationNote: 'A reported sensing capability must be checked for the specific sensor and mounting arrangement.',
    cta: 'Understand robot skin',
    href: '/robot-skin',
  },
  {
    name: 'Compare sensor hardware and evidence',
    bestFor: 'Engineers shortlisting tactile sensors for hands, grippers, or soft surfaces',
    summary: 'Compare optical, magnetic, resistive, and other sensing systems using their documented outputs, geometry, calibration requirements, and task evidence.',
    inputsOutputs: 'A sensing requirement becomes a shortlist with documented constraints and primary sources.',
    specs: ['DIGIT and GelSight Mini', 'ReSkin magnetic sensing', 'Raw data versus derived estimates', 'Mounting and calibration'],
    evaluation: ['What does the hardware measure directly?', 'Which values require a learned model?', 'Are code and calibration procedures available?', 'Was the claimed result measured on a comparable task?'],
    verificationNote: 'The sensor directory links to research and manufacturer documentation; it is not a stock or purchasing catalog.',
    cta: 'Compare tactile sensors',
    href: '/sensors',
  },
  {
    name: 'Build a tactile data and evaluation workflow',
    bestFor: 'Developers moving from a sensor stream to recorded data and robot feedback',
    summary: 'Follow the Python and ROS 2 exercises to inspect samples, preserve timestamps and units, replay observations, and define an evaluation before connecting a controller.',
    inputsOutputs: 'Recorded or synthetic observations become plots, replayable messages, and an explicit validation plan.',
    specs: ['Python CSV inspection', 'ROS 2 messages and replay', 'Calibration records', 'Task-level evaluation'],
    evaluation: ['Are time, units, and coordinate frames explicit?', 'Can invalid samples be identified?', 'Can the sequence be replayed?', 'Does evaluation measure object outcomes as well as prediction accuracy?'],
    verificationNote: 'Tutorial exercises use documented examples and synthetic data; running them does not establish hardware performance.',
    cta: 'Start the programming tutorials',
...
export const solutionCards = [
  {
    title: 'An object slips after the gripper closes',
    problem: 'Successful initial contact does not establish that the grasp will survive movement or disturbance.',
    why: 'Separate slip detection from the recovery action and the final object-retention outcome.',
    path: 'Start with slip cues, then compare sensor latency, false alarms, and closed-loop recovery evidence.',
    note: 'Record disturbances, contact geometry, and failed recoveries as well as successful trials.',
    href: '/guides/slip-detection-robot-hand',
    cta: 'Plan a slip-detection evaluation',
  },
  {
    title: 'A robot cannot tell where body contact occurs',
    problem: 'A fingertip sensor covers only a small part of the surfaces that may contact the environment.',
    why: 'Map likely contact regions before selecting distributed sensing and connecting readings to robot coordinates.',
    path: 'Review whole-hand, arm, and body coverage together with wiring, compliant mounting, and data routing.',
    note: 'Contact awareness is an input to a control system; it does not establish safety certification.',
    href: '/humanoid-robot-skin',
    cta: 'Map humanoid tactile coverage',
  },
  {
    title: 'Sensor readings change after remounting',
    problem: 'A new contact surface, lighting condition, or mounting arrangement can invalidate an earlier baseline.',
    why: 'Keep raw measurements, reconstructed geometry, and force estimates separate when diagnosing drift.',
    path: 'Define the measurement target, record a baseline, and validate calibration on held-out contacts.',
    note: 'An optical image is not automatically a calibrated force map.',
    href: '/guides/tactile-sensor-calibration',
    cta: 'Review the calibration workflow',
  },
  {
    title: 'A robot policy needs reusable touch data',
    problem: 'A paper describing tactile recordings does not guarantee downloadable data or a reusable license.',
    why: 'Check access, modality, embodiment, tasks, synchronization, and splits before choosing a dataset.',
    path: 'Use the tactile dataset directory, then inspect the primary files and evaluation protocol.',
    note: 'Keep adjacent frames from one trajectory out of both training and test splits.',
    href: '/datasets',
    cta: 'Find tactile datasets',
  },
];
...
export const faqItems: FaqItem[] = [
  {
    question: 'What is the difference between robot skin and a tactile sensor?',
    answer: 'A tactile sensor measures contact at an element or array. Robot skin is the integrated surface: sensors, mounting, electronics, data handling, and the robot response. A single fingertip sensor is not whole-body skin.',
    ctaLabel: 'Compare robot skin and tactile sensors', href: '/guides/robot-skin-vs-tactile-sensor',
  },
  {
    question: 'When is a simple touch sensor enough?',
    answer: 'A binary contact event can be sufficient for a state transition. Contact location, force distribution, or slip detection may need richer measurements and a separately validated processing pipeline.',
    ctaLabel: 'Compare contact switches and tactile sensing', href: '/guides/robot-touch-sensor',
  },
  {
    question: 'How do I choose a tactile sensor for a robot?',
    answer: 'Start with the task and contact geometry. Compare measured outputs, coverage, timing, calibration, replacement, software access, and task-level evidence. No sensing principle is best for every robot.',
    ctaLabel: 'Use the sensor selection guide', href: '/guides/tactile-sensor-for-robots',
  },
  {
    question: 'Does a tactile image directly measure force?',
    answer: 'An optical tactile sensor captures the appearance of its deformable surface. Geometry reconstruction or force estimation needs an appropriate model and calibration; image resolution alone is not force accuracy.',
    ctaLabel: 'Review calibration requirements', href: '/guides/tactile-sensor-calibration',
  },
  {
    question: 'What should I record when testing slip detection?',
    answer: 'Record the reference slip onset, detector output, false alarms, action timing, and whether the object was retained. Correct detection and successful recovery are different outcomes.',
    ctaLabel: 'Plan a slip-detection evaluation', href: '/guides/slip-detection-robot-hand',
  },
  {
    question: 'Where can I find tactile datasets with usable downloads?',
    answer: 'The dataset directory distinguishes verified files from paper-described collections. Check each provider link, data license, sensor modality, task, and train/test split before reuse.',
    ctaLabel: 'Check tactile dataset access', href: '/datasets',
  },
  {
    question: 'Can I learn tactile data processing without a robot?',
    answer: 'Yes. The Python tutorial uses synthetic CSV samples to practice inspection, plotting, and contact-event analysis. The ROS 2 tutorial adds message and replay exercises. These are learning exercises, not hardware benchmarks.',
    ctaLabel: 'Start the programming tutorials', href: '/robotics-programming',
  },
  {
    question: 'How does touch fit into Physical AI?',
    answer: 'Physical AI connects perception, decision-making, and action in a physical machine. Touch supplies contact feedback that a controller or learned policy can combine with vision and robot state.',
    ctaLabel: 'Read the Physical AI explainer', href: '/physical-ai',
  },
  {
    question: 'Does RoboSkin.ai sell robot skin hardware?',
    answer: 'RoboSkin.ai publishes independent research guides and offers scoped research services. Sensor references describe third-party hardware and research; they are not claims of stock, compatibility, or manufacturer support.',
    ctaLabel: 'About RoboSkin.ai', href: '/about',
  },
  {
    question: 'How can I correct a claim or suggest a source?',
    answer: 'Send the page URL, the statement to review, and a primary paper or official document. The editorial policy explains attribution and the separation between reported results and our interpretation.',
    ctaLabel: 'Send a source or correction', href: '/contact?requestType=research',
  },
];
