...
export const footerNavigation = [
  ...
  },
  {
    title: 'RoboSkin.ai',
    links: [
      { href: '/authors/steven-yang', label: 'Editor' },
      { href: '/reports/tactile-robotics-data-transparency-audit-2026', label: 'Dataset transparency audit' },
      { href: '/about', label: 'About' },
...
export const featuredIndustryAssets: FeaturedIndustryAsset[] = [
  {
    kicker: 'Original data audit',
    title: 'Tactile Robotics Dataset Transparency Audit',
    summary: 'A reproducible record-level audit of data URLs, direct license links, code, sampling-rate, synchronization, and split disclosure.',
    href: '/reports/tactile-robotics-data-transparency-audit-2026',
    ctaLabel: 'Inspect the audit',
    code: 'AUDIT-26',
    accent: 'blue',
    includes: ['Full current directory', 'Published rules', 'CSV output', 'JSON output'],
  ...
  {
    kicker: 'Versioned dataset',
    title: 'RoboSkin Tactile Research Index',
    summary: 'A versioned, source-reviewed index of robot-skin and tactile-AI work with explicit evidence classes and limitations.',
    href: '/research-index',
    ctaLabel: 'Open the index',
    code: 'INDEX-V1',
    accent: 'teal',
    includes: ['Source-reviewed records', 'CC BY 4.0', 'CSV and JSON', 'Versioned release'],
  ...
  {
    kicker: 'Evidence database',
    title: 'Tactile Robotics Benchmarks',
    summary: 'Compare named task protocols, robots, sensors, metrics, access, and limitations without collapsing incompatible scores.',
    href: '/benchmarks',
    ctaLabel: 'Compare benchmark evidence',
    code: 'BENCH-DB',
    accent: 'rose',
...
export const researchResourceIndex: ResearchResourceEntry[] = [
  ...
  {
    title: 'Tactile robotics dataset transparency audit',
    summary: 'A reproducible disclosure audit generated from the source-reviewed tactile dataset directory.',
    href: '/reports/tactile-robotics-data-transparency-audit-2026',
    label: 'Original data audit',
    image: '/generated/authority/humanoid-stack-map-cover.webp',
