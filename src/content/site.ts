...
export const footerNavigation = [
  {
    ...
    links: [
      ...
      { href: '/guides/tactile-sensor-benchmark-robot-manipulation', label: 'Sensor benchmark' },
      { href: '/solutions', label: 'Use cases' },
      { href: '/technology', label: 'Technology' },
      { href: '/resources', label: 'Library' },
      { href: '/guides/ros2-tactile-sensing', label: 'Integration guide' },
      { href: '/research/robot-skin-papers', label: 'Paper routes' },
    ],
  },
  {
    title: 'Company',
