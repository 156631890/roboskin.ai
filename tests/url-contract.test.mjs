...
test('the audited production URL inventory is protected', async () => {
  ...
  assert.ok(protectedUrls.includes('https://roboskin.ai/research/adept-visuo-tactile-dexterity-rl-2026'));
  assert.ok(protectedUrls.includes('https://roboskin.ai/research/vision-based-tactile-intelligence-robotics-survey-2026'));
  ...
  for (const path of [
    ...
    '/news/glotouch-global-local-haptic-search',
    '/news/copre-proprioceptive-contact-detection',
    ...
    '/news/polyumi-visual-tactile-audio-demonstration-interface',
    '/news/propra-fingertip-sensor-pretraining',
    '/news/whole-hand-force-regulation-without-tactile-sensors',
    '/news/res-hil-human-guided-residual-rl-manipulation',
    '/robotics-programming',
    '/guides/python-tactile-data-processing',
    '/guides/lerobot-dataset-format',
    '/guides/tactile-sensor-calibration',
    '/sensors/digit',
    '/sensors/gelsight-mini',
    '/sensors/reskin',
  ...
  assert.deepEqual(redirects, {
    ...
    '/applications/humanoid-robot-skin': '/humanoid-robot-skin',
    '/guides/tactile-datasets-robot-learning': '/datasets',
    '/guides/tactile-foundation-models': '/tactile-foundation-models',
    '/guides/physical-ai-touch-data': '/physical-ai-touch',
  });
});
...
test('the production snapshot preserves redirect sources instead of shrinking the URL contract', async () => {
