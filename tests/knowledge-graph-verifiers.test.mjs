...
test('RSS and production status reflect the current generated artifacts', async () => {
  ...
  assert.match(exportVerifier, /rssItems\.length !== 50[\s\S]*?rssLinks\.length !== 51[\s\S]*?rssGuids\.length !== 50/);
  assert.match(productionVerifier, /rssItems\.length !== 50[\s\S]*?rssLinks\.length !== 51[\s\S]*?rssGuids\.length !== 50/);
