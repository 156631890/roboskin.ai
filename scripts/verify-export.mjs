...
if (failures.length === 0) {
  ...
  if (rssItems.length !== 35 || rssLinks.length !== 36 || rssGuids.length !== 35) failures.push('/feed.xml: expected 35 complete items');
...
console.log(`Verified ${protectedUrls.length} indexable URLs, ${noindexUrls.length} noindex URLs, exact sitemap, 19 data records, and 35 RSS items`);
