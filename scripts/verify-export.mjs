...
if (failures.length === 0) {
  ...
  if (rssItems.length !== 36 || rssLinks.length !== 37 || rssGuids.length !== 36) failures.push('/feed.xml: expected 36 complete items');
...
console.log(`Verified ${protectedUrls.length} indexable URLs, ${noindexUrls.length} noindex URLs, exact sitemap, 19 data records, and 36 RSS items`);
