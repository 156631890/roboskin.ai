...
if (rssItems.length !== 36 || rssLinks.length !== 37 || rssGuids.length !== 36) throw new Error('RSS does not contain 36 complete items');
...
console.log(`Verified ${base.origin} at ${deployment.commitSha}: ${protectedUrls.length} indexable URLs, ${noindexUrls.length} noindex URLs, exact sitemap, 19 data records, and 36 RSS items`);
