...
if (rssItems.length !== 33 || rssLinks.length !== 34 || rssGuids.length !== 33) throw new Error('RSS does not contain 33 complete items');
...
console.log(`Verified ${base.origin} at ${deployment.commitSha}: ${protectedUrls.length} indexable URLs, ${noindexUrls.length} noindex URLs, exact sitemap, 17 data records, and 33 RSS items`);
