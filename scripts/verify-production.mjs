...
if (indexData.count !== 18 || indexData.entries?.length !== 18) throw new Error('Research index JSON does not contain 18 records');
...
if (rssItems.length !== 34 || rssLinks.length !== 35 || rssGuids.length !== 34) throw new Error('RSS does not contain 34 complete items');
...
console.log(`Verified ${base.origin} at ${deployment.commitSha}: ${protectedUrls.length} indexable URLs, ${noindexUrls.length} noindex URLs, exact sitemap, 18 data records, and 34 RSS items`);
